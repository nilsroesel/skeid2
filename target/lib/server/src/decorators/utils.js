...
function decoratedItemIsMethod(something) {
    return typeof something === 'function';
}
exports.decoratedItemIsMethod = decoratedItemIsMethod;
...
function assignOnlyDefinedMetadata(to, metadata, value) {
    if (value !== undefined) {
        Reflect.defineMetadata(metadata, value, to);
    }
}
exports.assignOnlyDefinedMetadata = assignOnlyDefinedMetadata;
